...
public class Premios extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.premios, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.perfil) {
            ...
            Intent i = new Intent(Premios.this, Indicar.class);
            startActivity(i);
        } else if (id == R.id.premio) {
            Intent i = new Intent(Premios.this, Premios.class);
            startActivity(i);
        } else if (id == R.id.status) {
            Intent a = new Intent(Premios.this, StatusIndicacoes.class);
            startActivity(a);
        } else if (id == R.id.configuracoes) {
            Intent e = new Intent(Premios.this, FaleConosc.class);
            startActivity(e);
